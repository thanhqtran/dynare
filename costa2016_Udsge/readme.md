...
- 'nk_gov_fiscal_adj_1.mod` to `nk_gov_fiscal_adj_4.mod`: NK with fiscal adjustments. 1 is no adjustment, 2 to 4 are small, medium, and big adjustments. Parameters governming these are $\phi_{\tau^c}, \phi_{\tau^l}, \phi_{\tau^k}$.
